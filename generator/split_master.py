...
if __name__ == "__main__":
  try:
    images_dir = "./Common Carotid Artery Ultrasound Images/US images/"
    masks_dir  = "./Common Carotid Artery Ultrasound Images/Expert mask images/"
    output_dir = "../dataset/CCAUS/"
